...
//19980124 OE3DZW renamed ELOG to ERLOG (for run-util EL) fuer DOS
...
//20251011 DC6AP  remove weather station and dos support
...
/*                   putf("      %ld\n", (tt-ad_timezone()));
    ...
    case hb9eas_debug:
         {
           if (b->sysop == 1 || ! strcmp(b->logincall, "DC6AP"))
           {
             ...
             putf("Only sysops and dc6ap can set this parameter!\n");
         } break;
#endif
#ifdef __LINUX__
    case lddversion:
