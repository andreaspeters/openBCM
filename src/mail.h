...
//20251011 DC6AP  added ansicolor
//20251012 DC6AP  add values for alter
...
{ char     call[CALLEN+1];          //  7 Rufzeichen des Users
  ...
  char     ansicolor;               //  1 ANSI Color
  char     restplatz[USERDBREST];   // 87 Restplatz -> USERDBREST definieren!!
...
{ m_sendnotpossible,    // send.cpp
  ...
  m_http_to,               // http.cpp
  m_ansicoloron,           // alter.cpp
  m_ansicoloroff,          // alter.cpp
  m_a_qth,                 // alter.cpp
  m_a_zip,                 // alter.cpp
  m_a_psoption,            // alter.cpp
  m_a_fhold,               // alter.cpp
  m_a_fwddelay,            // alter.cpp
  m_a_userforward,         // alter.cpp
  m_a_newcall,             // alter.cpp
  m_a_passive,             // alter.cpp
  m_a_dirformat,           // alter.cpp
  m_a_unsecure_smtp,       // alter.cpp
  m_a_paclen,              // alter.cpp
  m_a_comp_active,         // alter.cpp
  m_a_comp_not_active,     // alter.cpp
  m_a_status,              // alter.cpp
  m_a_nopurge,             // alter.cpp
  m_a_passwordlen,         // alter.cpp
  m_a_ttypwlen,            // alter.cpp
  m_a_linuxpwlen,          // alter.cpp
  m_a_loginpwtype,         // alter.cpp
  m_a_sfpwtype,            // alter.cpp
  m_a_pwline,              // alter.cpp
  m_a_readlock,            // alter.cpp
  m_a_fbbcheckmode,        // alter.cpp
  m_a_ansicolor,           // alter.cpp
  m_a_binmode_didat,       // alter.cpp
  m_a_binmode_binsplit,    // alter.cpp
  m_a_binmode_yapp,        // alter.cpp
  m_a_binmode_autobin,     // alter.cpp
  m_a_httpsurface,         // alter.cpp
  m_a_away,                // alter.cpp
  m_a_awayend,             // alter.cpp
  m_a_awaymessage,         // alter.cpp
  m_a_notification,        // alter.cpp
  m_off,                   // alter.cpp
  m_via,                   // alter.cpp
